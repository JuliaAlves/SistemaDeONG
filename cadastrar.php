		...
		if ($opcao=='Doador'){
			...
			if(isset($_POST['nome'])&&isset($_POST['email'])&& isset($_POST['endereco'])&&
				isset($_POST['frequencia'])&&isset($_POST['RG'])&&isset($_POST['telefone'])){
					...
					$sql= "INSERT INTO usuarioDoador VALUES ($usuario,(SELECT codDoador FROM Doador WHERE nome='$nome'))";      
                    $inseriu=$obj_con->insert($sql);
            }
           	else 
           		$faltaInfor=true;
            ...
            if (isset($_POST['nome'])&&isset($_POST['email'])&& isset($_POST['endereco'])&&
				isset($_POST['renda'])&&isset($_POST['RG'])&&isset($_POST['telefone'])){
                    ...
                    $sql="INSERT INTO usuarioCarente VALUES ('$usuario',(SELECT codCarente FROM Carente WHERE nome='$nome'))"; 
			        $inseriu=$obj_con->insert($sql);
            }   
            else 
            	$faltaInfor=true;           
            ...
            if (isset($_POST['nome'])&&isset($_POST['email'])&& isset($_POST['RG'])&&isset($_POST['telefone'])){
				...
				$inseriu=$obj_con->insert($sql);
                 ...
                 $sql ="INSERT INTO usuarioVoluntario VALUES ('$usuario',(SELECT codVoluntario FROM Voluntario WHERE nome='$nome'))"; 
			     $inseriu=$obj_con->insert($sql);
            }
            else 
            	$faltaInfor=true;
